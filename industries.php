...
<section class="tm2-section">
    <div class="tm2-container">
        ...
        $indFallback = [
            ...
            ['icon'=>'fa-solid fa-hand-holding-heart','color'=>'#a78bfa','title'=>'NGOs & Nonprofits','description'=>'We help nonprofits operate with the efficiency of a for-profit — donor management, program tracking, and impact reporting.'],
            ['icon'=>'fa-solid fa-building','color'=>'#64748b','title'=>'SMEs & Startups','description'=>'We help African SMEs and startups build the digital foundation they need to compete, scale, and attract investors.'],
            ['icon'=>'fa-solid fa-calendar-days','color'=>'#fb923c','title'=>'Events & Hospitality','description'=>'Booking systems, event management platforms, and hospitality tools designed for the African market.'],
