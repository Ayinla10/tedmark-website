            ...
            <div class="tm-fade">
                <div style="background:#fff;border-radius:20px;box-shadow:0 4px 32px rgba(0,0,0,.07);padding:40px;">
                    ...
                    <form id="roi-form" style="display:flex;flex-direction:column;gap:28px;">
                        ...
                        <div>
                            <label style="display:block;font-size:13px;font-weight:700;color:#475569;margin-bottom:10px;text-transform:uppercase;letter-spacing:.04em;">
                                Employees doing manual tasks
                            </label>
                            <div style="position:relative;">
                                <input type="number" id="roi-staff" min="1" max="500" value="5"
                                    style="width:100%;padding:14px 56px 14px 16px;border:2px solid #e2e8f0;border-radius:12px;font-size:16px;font-weight:600;color:#0f172a;box-sizing:border-box;outline:none;transition:border .2s;"
                                    oninput="syncSlider('roi-staff','slider-staff');calculateROI()">
                                <span style="position:absolute;right:14px;top:50%;transform:translateY(-50%);font-size:13px;color:#94a3b8;font-weight:600;">people</span>
                            </div>
                        ...
                        <div>
                            ...
                            <div style="position:relative;">
                                <input type="number" id="roi-hours" min="1" max="40" value="15"
                                    style="width:100%;padding:14px 64px 14px 16px;border:2px solid #e2e8f0;border-radius:12px;font-size:16px;font-weight:600;color:#0f172a;box-sizing:border-box;outline:none;transition:border .2s;"
                                    oninput="syncSlider('roi-hours','slider-hours');calculateROI()">
                                <span style="position:absolute;right:14px;top:50%;transform:translateY(-50%);font-size:13px;color:#94a3b8;font-weight:600;">hrs/wk</span>
                            </div>
                        ...
                        <div>
                            ...
                            <div style="position:relative;">
                                <span style="position:absolute;left:14px;top:50%;transform:translateY(-50%);color:#94a3b8;font-weight:600;">$</span>
                                <input type="number" id="roi-rate" min="1" max="200" value="12"
                                    style="width:100%;padding:14px 16px 14px 28px;border:2px solid #e2e8f0;border-radius:12px;font-size:16px;font-weight:600;color:#0f172a;box-sizing:border-box;outline:none;transition:border .2s;"
                        ...
                        <div>
                            ...
                            <div style="position:relative;">
                                <input type="number" id="roi-inefficiency" min="10" max="90" value="60"
                                    style="width:100%;padding:14px 32px 14px 16px;border:2px solid #e2e8f0;border-radius:12px;font-size:16px;font-weight:600;color:#0f172a;box-sizing:border-box;outline:none;transition:border .2s;"
                                    oninput="syncSlider('roi-inefficiency','slider-ineff');calculateROI()">
                                <span style="position:absolute;right:14px;top:50%;transform:translateY(-50%);color:#94a3b8;font-weight:600;">%</span>
                            </div>
            ...
            <div class="tm-fade" style="animation-delay:.1s">
                <div style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);border-radius:20px;padding:32px;">
                        <p style="font-size:12px;font-weight:700;color:#4ade80;text-transform:uppercase;letter-spacing:.08em;margin:0 0 8px;">Annual Savings with Automation</p>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                        <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:16px;padding:22px;">
                            <p style="font-size:11px;font-weight:700;color:#16a34a;text-transform:uppercase;letter-spacing:.06em;margin:0 0 6px;">Hours Recovered</p>
                        ...
                        <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:16px;padding:22px;">
                            <p style="font-size:11px;font-weight:700;color:#b45309;text-transform:uppercase;letter-spacing:.06em;margin:0 0 6px;">Efficiency Gain</p>
                    ...
                    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:24px;">
                        <p style="font-size:12px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.06em;margin:0 0 14px;">What you could do with that time</p>
                    ...
                    <div style="background:#020917;border-radius:16px;padding:24px;">
                        ...
                        <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
                            <span style="color:#fff;font-weight:600;font-size:14px;">Setup cost</span>
                            <span style="color:#4ade80;font-weight:700;font-size:14px;">$2,000 – $15,000</span>
                        </div>
                        <div style="display:flex;justify-content:space-between;margin-bottom:16px;">
                            <span style="color:#fff;font-weight:600;font-size:14px;">Monthly maintenance</span>
                            <span style="color:#4ade80;font-weight:700;font-size:14px;">$150 – $500</span>
                        </div>
